...
import EventDetail from './EventDetail1';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <main style={{ display: 'flex', flexDirection: 'column', flexGrow: 1, padding: '20px', backgroundColor: '#f4f4f4', overflowY: 'auto' }}>
        <h2 style={{ fontSize: '32px', fontWeight: 'bold', textTransform: 'uppercase' }}>Live Events</h2>
        <EventList events={liveEvents} showEventDetail={showEventDetail} />
        <h2 style={{ fontSize: '32px', fontWeight: 'bold', textTransform: 'uppercase' }}>Upcoming Events</h2>
        <EventList events={upcomingEvents} showEventDetail={showEventDetail} />
        <h2 style={{ fontSize: '32px', fontWeight: 'bold', textTransform: 'uppercase' }}>Past Events</h2>
