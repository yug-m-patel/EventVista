...
import Cyber from './assets/images/cyberpage.png';
...
//         <img
//           src={event.Thumbnail}
//           alt={`${event.EventTitle} thumbnail`}
//           className="object-cover w-full h-full"
//         />
//         <div className="absolute inset-0 bg-black bg-opacity-50"></div>
//         <div className="absolute inset-0 flex flex-col justify-between p-6 text-white">
//           <h2 className="text-3xl md:text-5xl font-bold text-center mb-4">{event.EventTitle}</h2>
//           <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
...
//               <div className="flex items-center space-x-2 text-sm md:text-base">
//                 <MapPinIcon className="w-4 h-4 md:w-5 md:h-5" />
//                 <span>{event.OfflineVenue || 'Online'}</span>
//               </div>
//             </div>
//           </div>
//         </div>
...
//         <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-70"></div>
//         <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
//           <h3 className="text-lg md:text-xl font-semibold mb-2">{event.EventTitle}</h3>
//           <div className="flex items-center space-x-2 text-sm">
//             <CalendarIcon className="w-4 h-4" />
//             <span>{format(new Date(event.Date), "MMMM d, yyyy")}</span>
//           </div>
